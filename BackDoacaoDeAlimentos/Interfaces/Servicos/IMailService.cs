...
namespace BackDoacaoDeAlimentos.Interfaces.Servicos
{
    ...
    {
        Task<bool> EnviarEmailRecuperacaoSenha(string nome, string usuario, string emailDestino, string link);
        MimeMessage CriarMensagemRecuperacao(string remetente, string nome, string usuario, string destino, string link);
